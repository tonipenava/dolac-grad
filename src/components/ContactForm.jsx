...
export const ContactForm = () => {
  ...
  return (
    <form
      ref={form}
      onSubmit={sendEmail}
      className="flex flex-col gap-4 items-center text-xl lg:w-1/3 w-4/5 lg:h-[69dvh] bg-bijela border-4 border-svjetlozelena p-4 font-thin rounded-tr-3xl rounded-bl-3xl"
    >
