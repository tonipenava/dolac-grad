...
const BackgroundElements = () => {
  ...
  return (
    <div
      ref={ref}
      className="   h-[40vh] bg-[url('/src/assets/livingRoom.jpg')] lg:bg-fixed lg:bg-cover lg:bg-center bg-no-repeat bg-cover shadow-inner overflow-hidden"
    >
      <div className="w-[full] h-full bg-bijela bg-opacity-60 lg:flex grid grid-cols-3 grid-rows-2 gap-4 lg:justify-center lg:gap-8 justify-center text-black font-semibold lg:text-2xl text-sm">
        ...
        <div className="flex flex-col justify-center items-center gap-2 text-center col-span-">
